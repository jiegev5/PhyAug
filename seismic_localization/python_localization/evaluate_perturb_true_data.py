...
if model == "mlp":
    filename = 'mlp_model_accuracy_on_true_data_eval_perturb_class_400.csv'
if model == "svm":
    filename = 'svm_model_accuracy_on_true_data_eval_perturb_class_400.csv'
# option is 'w'
