...
X1_bar = [xStaResh(1,:);yStaResh(1,:)]'; %can refer to source
X2_bar = [xStaResh(2,:);yStaResh(2,:)]'; %can refer to station

% reduce number of rays
N = 1000;
r = randperm(lenStaPerms,N); % select N rays from total number of rays
X1 = X1_bar(r,:);
X2 = X2_bar(r,:);
