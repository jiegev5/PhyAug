...
from data.data_loader import SpectrogramDataset, SpectrogramDataset_for_Train, SpectrogramDataset_npy, AudioDataLoader
...
parser.add_argument('--device-id', default=0, type=int, help='GPU number to use')
