...
if __name__ == "__main__":
    ...
    exp = 'exp_ABS_N4_20_rooms_{}'.format(s_mic)
    ...
    exp_list = [
        'exp_ABS_N4_20_rooms_pixel4_to_{}'.format(s_mic),
        'exp_ABS_N4_20_rooms_galaxys7_to_{}'.format(s_mic),
        'exp_ABS_N4_20_rooms_{}'.format(s_mic),
    ]
    for exp in exp_list:
        train_dataloader, test_dataloader = load_spec(opt=exp,batch_size=opt['batch_size'])
